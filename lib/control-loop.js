...
var globalConfig = {
  ...
  servos: {
    servo1 : {id:"servo1", controller:"pitch", pin:12, multiply : 1},
    servo2 : {id:"servo2", controller:"pitch", pin:12, multiply : 1}
  },
  interval: 100
};
...
var setMultiply = function(id, multiply) {
  globalConfig.servos[id].multiply = multiply;
  updateConfig();
}
    ...
    controlLoopInterval = setInterval(function(){
      ...
      for(var controllerName in globalConfig.controllers) {
        ...
        for(var servo of globalConfig.servos) {
          ...
          console.log("setting servo:" + servo.pin, input, correction, pwm);
          if(rpio) {
