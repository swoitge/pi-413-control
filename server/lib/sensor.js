...
var readData = function() {
  ...
  if(avgMode) {
    ...
    // return latest from samplesBuffer
    var latest = samplesBuffer[samplesBuffer.length-1];
...
var setAvgMode = function(enabled, interval) {
  ...
  if(!enabled) {
    ...
    // timer on
    intervalTimer = setInterval(intervalFunc, intervalMs);
  }
...
// turn on timer
setAvgMode(avgMode, intervalMs);

module.exports = {readData, setAvgMode};
